...
<!-- Mirrored from www.w3schools.com/python/showpython.asp?filename=demo_ref_file_truncate by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Mar 2021 22:12:16 GMT -->
<head>
  ...
  <div id="textareacontainer">
    <div id="textarea">
      <div id="textareawrapper">
        <div id="filenamecontainer"><span>demo_ref_file_truncate.py:</span></div>
  ...
  <div id="iframecontainer">
    <div id="iframe">
      <div id="iframewrapper">
        <div id="iframeResult" style="white-space:nowrap;overflow:auto;">C:\Users\My Name>python demo_file_truncate.py<br>Hello! Welcome to de
</div>
      </div>
    </div>
  </div>
